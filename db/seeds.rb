...
review1 = Review.create!(name: "John", last_name: "Doe", date: 2.years.ago, summary: "Blackbird was incredible! Because yea!", event: "Wedding")
review2 = Review.create!(name: "Jane", last_name: "Doe", date: 1.year.ago, summary: "Blackbird was incredible! Because yea!", event: "Birthday")
review3 = Review.create!(name: "John", last_name: "Smith", date: 8.months.ago, summary: "Blackbird was incredible! Because yea!", event: "Festival")
review4 = Review.create!(name: "Ashley", last_name: "Johnston", date: 8.weeks.ago, summary: "Blackbird was incredible! Because yea!", event: "Wedding")
review5 = Review.create!(name: "William", last_name: "Clay", date: 2.days.ago, summary: "Blackbird was incredible! Because yea!", event: "Wedding")
